...
<footer class="ftco-footer">
					...
					<div class="ftco-footer-widget">
						<h2 class="ftco-heading-2 d-flex align-items-center">About</h2>
							<ul class="list-unstyled mr-md-4">
								<li><a href="vision$mission.php"><span class="fa fa-chevron-right mr-2"></span>Vision & Mission</a></li>
								<li><a href="machines.php"><span class="fa fa-chevron-right mr-2"></span>Machines</a></li>
								<li><a href="qualitycontrol.php"><span class="fa fa-chevron-right mr-2"></span>Quality Control</a></li>
							</ul>
					...
					<div class="ftco-footer-widget">
						...
						<div class="d-flex">
							<ul class="list-unstyled mr-md-4">
								...
								<li><a href="factory.php"><span class="fa fa-chevron-right mr-2"></span>Factory</a></li>
								<li><a href="applications.php"><span class="fa fa-chevron-right mr-2"></span>Applications</a></li>
								<li><a href="iso.php"><span class="fa fa-chevron-right mr-2"></span>ISO Certificates</a></li>
							</ul>
							<ul class="list-unstyled mr-md-4">
								<li><a href="products.php"><span class="fa fa-chevron-right mr-2"></span>Product Field</a></li>
								<li><a href="materials.php"><span class="fa fa-chevron-right mr-2"></span>Materials</a></li>
								<li><a href="advantages.php"><span class="fa fa-chevron-right mr-2"></span>Advantages</a></li>
					...
					<div class="ftco-footer-widget">
						...
						<div class="block-23 mb-3">
							<ul>
								...
								<span class="text"><?php echo $row['LocationEn']?></span></li>
								<li>
		...
		if (isset($_SESSION['user'])){
			...
			$getProduct = $con->prepare("SELECT productsen.ProductID , productsen.ProductNameEn,
			 productsen.ProductNameAr FROM productsen");
			 $getProduct->execute();
					...
					<div class="form-field">
						<div class="select-wrap">
							...
							<select name="productid" id="" class="form-control">
								<option>Select Your Products</option><?php
							foreach($products as $product){?>
								<option value="<?php echo $product['ProductID'] ?>">
									<?php echo $product['ProductNameEn'] ?></option>
								<?php }?>
							</select>
						</div>
					</div>
