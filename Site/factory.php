	...
	<section class="ftco-section" id="about-section">
					...
					<div class="row justify-content-center mb-4 pt-md-4">
						<div class="col-md-12 heading-section ftco-animate">
                            <span class="subheading">In Power Pack</span>
								<h3 class="d-flex about" style="display: inline;">We demand the best for our company and clients, resulting in high quality and reliable manufacturing machinery imported from the best in the world</h3>
      ...
      <section>
        <div style="background-color: #fc5e28; margin-top: 0.5%; margin-bottom: 0.5%; margin-left: 0.5%; margin-right: 0.5%;  max-height: 5%">
            ...
            <h2 style="display: inline; text-align: center; margin-left: 5%; line-height:1.2; font-size: 40px; font-weight: 700; color:rgba(255, 255, 255, 0.7);" >Woven bags sewing</h2>            
			...
			<div class="row no-gutters">
				<div class="col-md-6 py-5 bg-secondary aside-stretch" style="padding-top: 3rem !important">
					<div class="heading-section heading-section-white p-4 pl-md-0 py-md-5 pr-md-5">
						...
						<h2 class="mb-4">Nonwoven bags sewing</h2>
					</div>
				</div>
            </div>
			</div>
      ...
      <section>
        <div style="background-color: #fc5e28; margin-top: 0.5%; margin-bottom: 0.5%; margin-left: 0.5%; margin-right: 0.5%;  max-height: 5%">
            ...
            <h2 style="display: inline; text-align: center ; line-height:1.2; font-size: 40px; font-weight: 700; color:rgba(255, 255, 255, 0.7);" >Nonwoven bags sealing  ultrasonic </h2>            
