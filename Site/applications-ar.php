					...
					<div class="row justify-content-center mb-4 pt-md-4">
						<div class="col-md-12 heading-section ftco-animate">
                            <span class="subheading">في باور باك</span>
								<h3 class="d-flex about" style="text-align: right;">
تقدم شركتنا حلاً لصناعات التغليف ، وتوفر طباعة آمنة وعالية الجودة ، وتصنيع مجموعة متنوعة من مواد تغليف المنتجات النهائية </h3>
    ...
    <section>
        <div style="background-color: #fc5e28; margin-top: 0.5%; margin-bottom: 0.5%; margin-left: 0.5%; margin-right: 0.5%;  max-height: 5%">
            ...
            <h2 style="display: inline; text-align: center; margin-left: 5%; line-height:1.2; font-size: 40px; font-weight: 700; color:rgba(255, 255, 255, 0.7);" >تغليف المنتج</h2>            
